        ...
        return (
            <div className={styles.wrapper}>
                ...
                <div className={classNames( styles.innerWrapper )}>
                    ...
                    {pathname === '/' && (
                    <a className={styles.cssdaBadge} href="https://www.cssdesignawards.com/sites/luceolab/33382" target="_blank">
                    <div id="cssda-badge">
                        <svg version="1.1" id="cssda-badge-logo" x="0px" y="0px"
                          viewBox="0 0 90 90">
                        ...
                        <div className="cssda-badge-content">
                          <svg version="1.1" id="cssda-badge-title" x="0px" y="0px"
                            viewBox="0 0 90 90">
                    	...
                    	<path d="M74.6,53.8c-0.5-0.1-0.8-0.4-1-0.8s-0.2-0.9-0.1-1.5c0.1-0.5,0.3-1,0.6-1.4l1,0.2c-0.2,0.3-0.4,0.6-0.5,0.8
                          ...
                          <svg version="1.1" id="cssda-badge-award" x="0px" y="0px"
                            viewBox="0 0 90 90">
