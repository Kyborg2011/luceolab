                ...
                if ( typeof window.changedPath === 'undefined' || !window.changedPath.prev ) {
                  ...
                  function( func ) {
                    ...
                    let render = function( angle, lightOn ) {
                        ...
                        context.moveTo( Math.floor( canvasWidth * 0.699 + shiftX ), 0 );
                        context.lineTo( Math.floor( -ballX + canvasWidth * 0.699 + shiftX ), ballY );
                        context.closePath();
                        context.stroke();

                        context.translate( Math.floor( canvasWidth * 0.699 + shiftX ), 0 );
                    ...
                    var sim = PendulumSim( 5, 8, Math.PI * 70 / 100, 10, render );
