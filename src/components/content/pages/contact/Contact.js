                        ...
                        <div className={styles.info}>
                            ...
                            <ul className={styles.socialNetworks}>
                                <li className={styles.facebookBtn}>
                                    <a href="https://www.facebook.com/luceolabagency/" target="_blank">
                                ...
                                <li><a href="https://www.instagram.com/luceolabcom/" target="_blank"><span className="fa fa-instagram" /></a></li>
                                <li className={styles.facebookBtn}>
                                    <a href="https://twitter.com/luceolabcom" target="_blank">
