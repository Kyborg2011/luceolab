        ...
        return (
            <header className={styles.header}>
                ...
                <nav className={styles.primaryNav}>
                    ...
                    <a className={styles.facebookIcon} href="https://www.facebook.com/luceolabagency/" target="_blank">
                    ...
                    <a className={styles.githubIcon} href="https://github.com/luceolab/Luceolab2018" target="_blank"
